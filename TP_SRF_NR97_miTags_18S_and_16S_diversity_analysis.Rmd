...
#read data 
TP_NR97_18S_miTags_tax <- read.table(file="/home/laura/Documents/TFM/home/data/TARASPINA/NR97/TP_SRF/second_submission_tables/otutb_NR97_TP_SRF_miTags_18S.txt", head=TRUE, fill=TRUE)

#table dimensions and format before setting column names
dim(TP_NR97_18S_miTags_tax) # 3246   58
...
amplicons_per_sample_TP_NR97_18S[which(colSums(TP_NR97_18S_miTags_tax_occur)<686)]
# samples st030, st101, st120, TARA_93_SUR_0d2.3 and TARA_94_SUR_0d2.3 have less than 686 reads.

#remove samples with less than 686 reads
TP_NR97_18S_miTags_tax_occur_min686 <- TP_NR97_18S_miTags_tax_occur[,colSums(TP_NR97_18S_miTags_tax_occur) >= 686]
dim(TP_NR97_18S_miTags_tax_occur_min686)

#let's check if we loose any OTU when excluding the mentioned stations.
TP_NR97_18S_miTags_tax_occur_min686_no_cero<-TP_NR97_18S_miTags_tax_occur_min686[,-(which(colSums(TP_NR97_18S_miTags_tax_occur_min686)==0))]
dim(TP_NR97_18S_miTags_tax_occur_min686_no_cero)
```
...
Let's normalize the original dataset by randomly subsampling 686 reads in each station:

``` {r species_richness_rarefaction1_18S, echo=TRUE}
library(vegan)
TP_NR97_18S_miTags_tax_occur_min686_t<-t(TP_NR97_18S_miTags_tax_occur_min686)
TP_NR97_18S_miTags_tax_occur_ss686<-rrarefy(TP_NR97_18S_miTags_tax_occur_min686_t, 686)
```

The normalized table shows the following dimensions and format:

```{r species_richness_rarefaction2_18S, echo=FALSE}
dim(TP_NR97_18S_miTags_tax_occur_ss686)
TP_NR97_18S_miTags_tax_occur_ss686[1:5,1:5]
```

Its content fits with the expected normalization values (686 reads per station):

``` {r species_richness_rarefaction3_18S, echo=TRUE}
rowSums(TP_NR97_18S_miTags_tax_occur_ss686)
```

Let's check out how many OTUs don't appear in the new table:

```{r species_richness_rarefaction4_18S, echo=1:5}
length(which(colSums(TP_NR97_18S_miTags_tax_occur_ss686)==0)) 
```
...
TP_NR97_18S_miTags_tax_occur_ss686_no_cero<-TP_NR97_18S_miTags_tax_occur_ss686[,-(which(colSums(TP_NR97_18S_miTags_tax_occur_ss686)==0))]
dim(TP_NR97_18S_miTags_tax_occur_ss686_no_cero)
...
dim(TP_NR97_18S_miTags_tax_occur_ss686_no_cero) --> 50 2040
...
Let's add the taxonomic classification to the left OTUs by merging "TP_NR97_18S_miTags_tax_occur_ss686_no_cero" with "TP_NR97_18S_tax":

```{r merge_tables_18S, echo=FALSE}
TP_NR97_18S_miTags_tax_occur_ss686_no_cero_t<-t(TP_NR97_18S_miTags_tax_occur_ss686_no_cero)
TP_NR97_18S_miTags_tax<-merge(TP_NR97_18S_miTags_tax_occur_ss686_no_cero_t,TP_NR97_18S_miTags_class, by="row.names")
...
Phaeophyceae_tb <- TP_NR97_18S_miTags_phototrophs[which(TP_NR97_18S_miTags_phototrophs$class == "Phaeophyceae"),]
...
TP_NR97_18S_miTags_OTUs_reads_samples$samples_per_class<-c(50,50,49,43,48,47,49,45,45,33,35,33,19,10,10,7,4,3,1,1)
...
ggplot(TP_NR97_18S_miTags_OTUs_reads_samples) +
  geom_point(aes(OTUs_per_class,reads_per_class)) +
  geom_text_repel(aes(OTUs_per_class,reads_per_class, label = rownames(TP_NR97_18S_miTags_OTUs_reads_samples)), size=4, force = 8, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_log10(limits = c(-1, 500), breaks=c(0,1,10,100)) + scale_y_log10(limits = c(-1,10000), breaks = c(0,1,10,100,1000,10000)) + labs(title="[2.2] Reads per class vs. OTUs per class", x="\nTP-miTags-18S OTUs", y="TP-miTags-18S reads\n") + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
...
ggplot(TP_NR97_18S_miTags_OTUs_reads_samples_rel_abund) +
  geom_point(aes(OTUs_per_class, reads_per_class)) +
  geom_text_repel(aes(OTUs_per_class, reads_per_class, label = rownames(TP_NR97_18S_miTags_OTUs_reads_samples_rel_abund)), size=4, force = 3, box.padding = unit(0.1, "lines"), point.padding = unit(0.02, 'lines')) + labs(title="[4.3] Reads per class vs. OTUs per class", x="\nTP-miTags-18S OTUs (%)", y="TP-miTags-18S reads (%)\n") + scale_x_log10(limits = c(-1,105), breaks = c(0,0.1,1,10,100)) + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100))  + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```

```{r reads_vs_samples_18S, echo=FALSE}
ggplot(TP_NR97_18S_miTags_OTUs_reads_samples_rel_abund) +
  geom_point(aes(samples_per_class,reads_per_class)) +
  geom_text_repel(aes(samples_per_class,reads_per_class, label = rownames(TP_NR97_18S_miTags_OTUs_reads_samples_rel_abund)), size=4, force = 8, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_continuous(limits = c(0, 116), breaks=c(25,50,75,100)) + labs(title="[New] Reads per class vs. samples in which they occur", x="\nTP-miTags-18S samples (%)", y="TP-miTags-18S reads (%)\n") + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
TP_NR97_18S_miTags_tax_occur_min686_t<-TP_NR97_18S_miTags_tax_occur_min686
TP_NR97_18S_miTags_min686_tax<-merge(TP_NR97_18S_miTags_tax_occur_min686_t,TP_NR97_18S_miTags_class, by="row.names")

dim(TP_NR97_18S_miTags_min686_tax)
TP_NR97_18S_miTags_min686_tax[1:5,1:5]

#fix OTU_no as new row
rownames(TP_NR97_18S_miTags_min686_tax)=TP_NR97_18S_miTags_min686_tax$Row.names

#add OTU_no as rowname
rownames.TP_NR97_18S_miTags_min686_tax<-TP_NR97_18S_miTags_min686_tax[,1]
TP_NR97_18S_miTags_min686_tax<-TP_NR97_18S_miTags_min686_tax[,-1]
#colnames(TP_NR97_18S_miTags_min686_tax, do.NULL=F)

dim(TP_NR97_18S_miTags_min686_tax)
TP_NR97_18S_miTags_min686_tax[1:5, 1:5]

#sort by OTU_no (split rowname, introduce no. into column "OTU_no" and sort)
TP_NR97_18S_miTags_min686_tax["OTU_no"] <- NA
TP_NR97_18S_miTags_min686_tax$OTU_no <- sapply(strsplit(rownames(TP_NR97_18S_miTags_min686_tax),split= "\\_"),'[',2)
TP_NR97_18S_miTags_min686_tax$OTU_no <- as.numeric(as.character(TP_NR97_18S_miTags_min686_tax$OTU_no))
TP_NR97_18S_miTags_min686_tax_sorted<-TP_NR97_18S_miTags_min686_tax[order(TP_NR97_18S_miTags_min686_tax$OTU_no, decreasing = FALSE), ]

dim(TP_NR97_18S_miTags_min686_tax_sorted)
TP_NR97_18S_miTags_min686_tax_sorted[1:5,1:5]
```

```{r select_phototrophs_non.norm_18S, echo=FALSE}
TP_NR97_18S_miTags_phototrophs_non.norm <- TP_NR97_18S_miTags_min686_tax_sorted[which(TP_NR97_18S_miTags_min686_tax_sorted$class != "heterotrophic_protist" & TP_NR97_18S_miTags_min686_tax_sorted$class != "NA" & TP_NR97_18S_miTags_min686_tax_sorted$class != ""),]
...
TP_NR97_18S_miTags_OTUs_reads_samples_non.norm$samples_per_class<-c(50,50,50,49,50,50,50,49,46,46,25,22,6,4,1,1,1,1,1,1)
...
Let's read the dataset and remove the samples containing less than 686 reads:

``` {r load_data_16S, echo=FALSE, message=FALSE}
#read data 
TP_NR97_16S_miTags_tax <- read.table(file="/home/laura/Documents/TFM/home/data/TARASPINA/NR97/TP_SRF/second_submission_tables/otutb_NR97_TP_SRF_miTags_16S.txt", head=TRUE, fill=TRUE)

#table dimensions and format before setting column names
dim(TP_NR97_16S_miTags_tax) # 16314    59
...
amplicons_per_sample_TP_NR97_16S[which(colSums(TP_NR97_16S_miTags_tax_occur)<18214)]
#only st101 has less than 18214 reads. We'll normalize at 18214 reads.
...
TP_NR97_16S_miTags_tax_occur_min18214<-subset(TP_NR97_16S_miTags_tax_occur, select=-c(st030, st101, st120, TARA_93_SUR_0d2.3, TARA_94_SUR_0d2.3))
dim(TP_NR97_16S_miTags_tax_occur_min18214) #8248    9
TP_NR97_16S_miTags_tax_occur_min18214[1:5,1:5]

#let's check if we loose any OTU when excluding the mentioned stations.
TP_NR97_16S_miTags_tax_occur_min18214_no_cero<-TP_NR97_16S_miTags_tax_occur_min18214[,-(which(colSums(TP_NR97_16S_miTags_tax_occur_min18214)==0))]
dim(TP_NR97_16S_miTags_tax_occur_min18214_no_cero)
```

## 2.2) Normalization

Let's normalize the original dataset by randomly subsampling 18214 reads in each station:

``` {r species_richness_rarefaction1_16S, echo=TRUE}
TP_NR97_16S_miTags_tax_occur_min18214_t<-t(TP_NR97_16S_miTags_tax_occur_min18214)
TP_NR97_16S_miTags_tax_occur_ss18214<-rrarefy(TP_NR97_16S_miTags_tax_occur_min18214_t, 18214)
```

The normalized table shows the following dimensions and format:

```{r species_richness_rarefaction2_16S, echo=FALSE}
dim(TP_NR97_16S_miTags_tax_occur_ss18214)
TP_NR97_16S_miTags_tax_occur_ss18214[1:5,1:5]
```

Its content fits with the expected normalization values (18214 reads per station):

``` {r species_richness_rarefaction3_16S, echo=TRUE}
rowSums(TP_NR97_16S_miTags_tax_occur_ss18214)
```

Let's check out how many OTUs don't appear in the new table:

```{r species_richness_rarefaction4_16S, echo=1:5}
length(which(colSums(TP_NR97_16S_miTags_tax_occur_ss18214)==0)) 
```
...
TP_NR97_16S_miTags_tax_occur_ss18214_no_cero<-TP_NR97_16S_miTags_tax_occur_ss18214[,-(which(colSums(TP_NR97_16S_miTags_tax_occur_ss18214)==0))]
dim(TP_NR97_16S_miTags_tax_occur_ss18214_no_cero)
...
dim(TP_NR97_16S_miTags_tax_occur_ss18214_no_cero) -->  50 10526

## 2.3) Taxonomic composition analysis

### 2.3.1) Normalized data

Let's add the taxonomic classification to the left OTUs by merging "TP_NR97_16S_miTags_tax_occur_ss18214_no_cero" with "TP_NR97_16S_miTags_tax".

```{r merge_tables_16S, echo=FALSE}
TP_NR97_16S_miTags_tax_occur_ss18214_no_cero_t<-t(TP_NR97_16S_miTags_tax_occur_ss18214_no_cero)
TP_NR97_16S_miTags_ss18214_tax<-merge(TP_NR97_16S_miTags_tax_occur_ss18214_no_cero_t,TP_NR97_16S_miTags_class, by="row.names")

dim(TP_NR97_16S_miTags_ss18214_tax)
TP_NR97_16S_miTags_ss18214_tax[1:5,1:5]

#fix OTU_no as new row
rownames(TP_NR97_16S_miTags_ss18214_tax)=TP_NR97_16S_miTags_ss18214_tax$Row.names

#add OTU_no as rowname
rownames.TP_NR97_16S_miTags_ss18214_tax<-TP_NR97_16S_miTags_ss18214_tax[,1]
TP_NR97_16S_miTags_ss18214_tax<-TP_NR97_16S_miTags_ss18214_tax[,-1]
#colnames(TP_NR97_16S_miTags_ss18214_tax, do.NULL=F)

dim(TP_NR97_16S_miTags_ss18214_tax)
TP_NR97_16S_miTags_ss18214_tax[1:5, 1:5]

#sort by OTU_no (split rowname, introduce no. into column "OTU_no" and sort)
TP_NR97_16S_miTags_ss18214_tax["OTU_no"] <- NA
TP_NR97_16S_miTags_ss18214_tax$OTU_no <- sapply(strsplit(rownames(TP_NR97_16S_miTags_ss18214_tax),split= "\\_"),'[',2)
TP_NR97_16S_miTags_ss18214_tax$OTU_no <- as.numeric(as.character(TP_NR97_16S_miTags_ss18214_tax$OTU_no))
TP_NR97_16S_miTags_ss18214_tax_sorted<-TP_NR97_16S_miTags_ss18214_tax[order(TP_NR97_16S_miTags_ss18214_tax$OTU_no, decreasing = FALSE), ]

dim(TP_NR97_16S_miTags_ss18214_tax_sorted)
TP_NR97_16S_miTags_ss18214_tax_sorted[1:5,10:11]
```

```{r select_phototrophs_16S2, echo=FALSE}
TP_NR97_16S_miTags_bacteria <- TP_NR97_16S_miTags_ss18214_tax_sorted[which(TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Bolidophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Chlorarachniophyta" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Cryptophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Pelagophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Rappemonad" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Cryptomonadales" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Bacillariophyta" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Dictyochophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Mamiellophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Prasinophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Eustigmatales" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Trebouxiophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Prymnesiophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Dinophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Chrysophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Chlorophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Ulvophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Raphydophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Phaeothamniophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Xanthophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Chlorodendrophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Nephroselmis" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Rhodophyta" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Pavlovophyceae" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "other_plastids" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != ""),]

TP_NR97_16S_miTags_protists <- TP_NR97_16S_miTags_ss18214_tax_sorted[which(TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "heterotrophic_bacteria" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != "Cyanobacteria" & TP_NR97_16S_miTags_ss18214_tax_sorted$class_A != ""),]
...
#CAREFUL! FIRST GROUP IS "other plastids"!
TP_NR97_16S_miTags_protists_OTUs_reads_samples$samples_per_class<-c(50,50,47,29,46,23,21,25,15,5,7,6,1,2,1)
...
ggplot(TP_NR97_16S_miTags_protists_plus_bacteria_OTUs_reads_samples) +
  geom_point(aes(OTUs_per_class,reads_per_class)) +
  geom_text_repel(aes(OTUs_per_class,reads_per_class, label = rownames(TP_NR97_16S_miTags_protists_plus_bacteria_OTUs_reads_samples)), size=4, force = 8, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_log10(limits = c(-1,1000), breaks=c(0,0.1,1,10,100,1000)) + scale_y_log10(limits = c(-1,150000), breaks = c(0,0.1,1,10,100,1000,10000,100000)) + labs(title="[10.2] Reads per class vs. OTUs per class", x="\nTP-miTags-16S OTUs", y="TP-miTags-16S reads\n") + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
...
ggplot(TP_NR97_16S_miTags_protists_plus_bacteria_OTUs_reads_samples_rel_abund) +
  geom_point(aes(OTUs_per_class, reads_per_class)) +
  geom_text_repel(aes(OTUs_per_class, reads_per_class, label = rownames(TP_NR97_16S_miTags_protists_plus_bacteria_OTUs_reads_samples_rel_abund)), size=4, force = 3, box.padding = unit(0.1, "lines"), point.padding = unit(0.02, 'lines')) + labs(title="[14.3] Reads per class vs. OTUs per class", x="\nTP-miTags-16S OTUs (%)", y="TP-miTags-16S reads (%)\n") + scale_x_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100))  + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```

```{r reads_vs_samples_16S, echo=FALSE}
ggplot(TP_NR97_16S_miTags_protists_plus_bacteria_OTUs_reads_samples_rel_abund) +
  geom_point(aes(samples_per_class,reads_per_class)) +
  geom_text_repel(aes(samples_per_class,reads_per_class, label = rownames(TP_NR97_16S_miTags_protists_plus_bacteria_OTUs_reads_samples_rel_abund)), size=4, force = 5, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_continuous(limits = c(0, 116), breaks=c(25,50,75,100)) + labs(title="[New] Reads per class vs. samples in which they occur", x="\nTP-miTags-16S samples (%)", y="TP-miTags-16S reads (%)\n") + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
TP_NR97_16S_miTags_tax_occur_min18214_no_cero_t<-TP_NR97_16S_miTags_tax_occur_min18214
TP_NR97_16S_miTags_min18214_tax<-merge(TP_NR97_16S_miTags_tax_occur_min18214_no_cero_t,TP_NR97_16S_miTags_class, by="row.names")

dim(TP_NR97_16S_miTags_min18214_tax)
TP_NR97_16S_miTags_min18214_tax[1:5,1:5]

#fix OTU_no as new row
rownames(TP_NR97_16S_miTags_min18214_tax)=TP_NR97_16S_miTags_min18214_tax$Row.names

#add OTU_no as rowname
rownames.TP_NR97_16S_miTags_min18214_tax<-TP_NR97_16S_miTags_min18214_tax[,1]
TP_NR97_16S_miTags_min18214_tax<-TP_NR97_16S_miTags_min18214_tax[,-1]
#colnames(TP_NR97_16S_miTags_min18214_tax, do.NULL=F)

dim(TP_NR97_16S_miTags_min18214_tax)
TP_NR97_16S_miTags_min18214_tax[1:5, 1:5]

#sort by OTU_no (split rowname, introduce no. into column "OTU_no" and sort)
TP_NR97_16S_miTags_min18214_tax["OTU_no"] <- NA
TP_NR97_16S_miTags_min18214_tax$OTU_no <- sapply(strsplit(rownames(TP_NR97_16S_miTags_min18214_tax),split= "\\_"),'[',2)
TP_NR97_16S_miTags_min18214_tax$OTU_no <- as.numeric(as.character(TP_NR97_16S_miTags_min18214_tax$OTU_no))
TP_NR97_16S_miTags_min18214_tax_sorted<-TP_NR97_16S_miTags_min18214_tax[order(TP_NR97_16S_miTags_min18214_tax$OTU_no, decreasing = FALSE), ]

dim(TP_NR97_16S_miTags_min18214_tax_sorted)
TP_NR97_16S_miTags_min18214_tax_sorted[1:5,1:5]
```

```{r select_phototrophs_16S_non.norm, echo=FALSE}
TP_NR97_16S_miTags_bacteria_non.norm <- TP_NR97_16S_miTags_min18214_tax_sorted[which(TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Bolidophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Chlorarachniophyta" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Cryptophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Pelagophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Rappemonad" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Cryptomonadales" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Bacillariophyta" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Dictyochophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Mamiellophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Prasinophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Eustigmatales" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Trebouxiophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Prymnesiophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Dinophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Chrysophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Chlorophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Ulvophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Raphydophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Phaeothamniophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Xanthophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Chlorodendrophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Nephroselmis" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Rhodophyta" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Pavlovophyceae" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "other_plastids" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != ""),]

TP_NR97_16S_miTags_protists_non.norm <- TP_NR97_16S_miTags_min18214_tax_sorted[which(TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "heterotrophic_bacteria" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != "Cyanobacteria" & TP_NR97_16S_miTags_min18214_tax_sorted$class_A != ""),]
...
library(vegan)
#TP_NR97_18S_miTags_tax_occur_min686_no_cero.bray<-vegdist(TP_NR97_18S_miTags_tax_occur_min686_no_cero, method="bray")
#TP_NR97_18S_miTags_tax_occur_min686_no_cero.bray<-as.matrix(TP_NR97_18S_miTags_tax_occur_min686_no_cero.bray)

#TP_NR97_16S_miTags_tax_occur_min18214_no_cero.bray<-vegdist(TP_NR97_16S_miTags_tax_occur_min18214_no_cero, method="bray")
#TP_NR97_16S_miTags_tax_occur_min18214_no_cero.bray<-as.matrix(TP_NR97_16S_miTags_tax_occur_min18214_no_cero.bray)

#mantel(TP_NR97_18S_miTags_tax_occur_min686_no_cero.bray, TP_NR97_16S_miTags_tax_occur_min18214_no_cero.bray)
```

```{r cyanobacteria_histogram, echo=TRUE}
cyano_tb <- TP_NR97_16S_miTags_bacteria[which(TP_NR97_16S_miTags_bacteria$class_A != "heterotrophic_bacteria"),]

class_summary_reads_per_class_cyano<-aggregate(rowSums(cyano_tb[1:50]), list(cyano_tb$class_B), sum)
# count the different groups
class_summary_otus_per_class_cyano<-aggregate(rowSums(cyano_tb[1:50]), list(cyano_tb$class_B), length)
...
cyano_OTUs_reads_rel_abund2<-read.table("/home/laura/Documents/TFM/home/data/TARASPINA/NR97/TP_SRF/cyano_histograms_data2.txt", head=TRUE)
